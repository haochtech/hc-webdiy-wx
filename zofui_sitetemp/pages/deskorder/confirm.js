...
Page(Object.assign({}, t.zan.Field, {
    ...
    postchange: function(a, e) {
        ...
        e && (o.address = 1), t.com.http("confirm", "POST", o, 0, !0, "", "", function(a) {
            a.data.errno ? t.com.alert(a.data.message) : (r.setData({
    ...
    payit: function(a) {
        ...
        if (e.data.form.length > 0) for (var s = 0; s < e.data.form.length; s++) for (var n in r) if (e.data.form[s].id == n) {
            if (1 != e.data.form[s].ismust && (!r[n] || r[n].length <= 0)) {
                var d = "请选择";
                return "0" != e.data.form[s].type && "1" != e.data.form[s].type || (d = "请填写"), 
                t.com.alert(d + e.data.form[s].name), !1;
            }
            o.push({
                id: n,
                value: r[n]
        ...
        t.com.http("confirm", "POST", i, 0, !0, "", "", function(a) {
    ...
    bindformChange: function(t) {
        for (var e = this, r = e.data.form, o = 0; o < r.length; o++) if (r[o].id == t.currentTarget.dataset.i) {
            if ("checkbox" == t.currentTarget.dataset.type) for (var s in r[o].sitem) {
                n = "form[" + o + "].checkbox[" + s + "]";
                t.detail.value.indexOf(r[o].sitem[s]) > -1 ? e.setData(a({}, n, !0)) : e.setData(a({}, n, !1));
            } else {
                var n = "form[" + o + "].value";
                e.setData(a({}, n, t.detail.value));
            }
            return !1;
        }
    },
