...
Page(Object.assign({}, a.zan.Quantity, {
    ...
    onLoad: function(t) {
        var e = this;
        a.com.comfunc(this), t.gid = t.gid ? t.gid : t.scene ? t.scene : 0, e.setData({
            ...
            e.setData({
                ...
                }), require("../../resource/wxParse/wxParse.js").wxParse("good.content", "html", t.data.data.good.content, e, 0), 
        ...
        if ("buy" == t.currentTarget.dataset.type) {
            ...
            a.com.http("good", "POST", i, 0, !0, "", "", function(t) {
                t.data.errno || void 0 === t.data.errno ? a.util.message(t.data.message, "", "error") : wx.navigateTo({
                    url: "/zofui_sitetemp/pages/deskorder/confirm?tid=" + e.data.tid
                });
            });
